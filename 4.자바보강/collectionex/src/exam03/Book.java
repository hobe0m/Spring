...
public class Book implements Comparable<Book> {
    ...
    public int compareTo(Book o) {
        // 현재 대상 - 비교 대상 : 오름 차순
        // 비교 대상 - 현재 대상 : 내림 차순
        // return title.hashCode() - o.title.hashCode(); : 오름 차순
        // return o.title.hashCode() - title.hashCode(); // : 내림 차순
        // return title.compareTo(o.title); // 오름 차순
        // return o.title.compareTo(o.title); // 내림 차순
        return title.compareTo(o.title) * -1; // 내림 차순
    }
}